public class FindUnionOfTwoSortedArrays {
    ...
    public static void main(String[] args) {
        int arr1[] = {2, 2, 3, 8, 10, 16, 18};
        int arr2[] = {1, 2, 5, 5, 5, 5, 5, 8, 8, 8, 8, 15, 20, 21};

        FindUnionOfTwoSortedArrays union = new FindUnionOfTwoSortedArrays();

        int arr[] = union.findUnion(arr1, arr2);
    ...
    private int[] findUnion(int[] arr1, int[] arr2){
